...
public class AimCommand extends Command {
  ...
  // PID Stuff!
  PIDController m_aimController = new PIDController(VisionConstants.p_rotate_to_tag, VisionConstants.i_rotate_to_tag, VisionConstants.d_rotate_to_tag);
  ...
  public void execute() {
    ...
    if (tag_in_view) m_robotDrive.drive(0, 0, limelight_aim_proportional(), false);
  ...
  private double limelight_aim_proportional() {
    ...
    double targetingAngularVelocity = m_aimController.calculate((LimelightHelpers.getTX(VisionConstants.LIMELIGHT_NAME)));
